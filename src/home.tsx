...
const Sidebar: React.FC = () => {
    ...
    return(
        <div
      className={`flex flex-col h-screen p-2 bg-gray-800 text-white transition-all duration-300 ${
...
const Home: React.FC = () => {
  ...
  return (
    ...
    <Sidebar />
    <div className='w-full'><span className='text-2xl'>WELOCME TO GOAL TRACKER</span></div>
    </div>
  );
};
